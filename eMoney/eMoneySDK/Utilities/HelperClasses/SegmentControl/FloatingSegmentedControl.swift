...
//        let bundle = Bundle(for: type(of: self))
    ...
    private func updateFocusSegment() {
        ...
        knob.layer.borderColor = AppColor.eAnd_Grey_10.cgColor
        ...
        if focusedIndex < segments.count {
            ...
            knob.isHidden = false
            knobWidthConstraint.constant = max(targetFrame.width, knob.segmentHeight)
            ...
            knob.isHidden = true
            knobWidthConstraint.constant = knob.segmentHeight
