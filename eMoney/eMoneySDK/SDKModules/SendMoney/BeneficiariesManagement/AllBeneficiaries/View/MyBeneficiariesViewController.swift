//
//  MyBeneficiariesViewController.swift
//  e&money
//
...
class MyBeneficiariesViewController: BaseViewController {
    @IBOutlet weak var tblView: UITableView!
    
    @IBOutlet weak var collectionView: UICollectionView!
    // MARK: Properties
    
    var presenter: MyBeneficiariesPresenterProtocol!
...
extension MyBeneficiariesViewController: MyBeneficiariesViewProtocol {
    ...
    private func setUpNavbar(){
        self.navigationItem.setTitle(title: "My beneficiaries")
...
extension MyBeneficiariesViewController: UITableViewDataSource {
...
extension MyBeneficiariesViewController: UITableViewDelegate {
...
extension MyBeneficiariesViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
