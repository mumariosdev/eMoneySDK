...
class SendMoneySuccessViewController: BaseViewController {
    ...
    // MARK: Properties
    var presenter: SendMoneySuccessPresenterProtocol!
...
extension SendMoneySuccessViewController: SendMoneySuccessViewProtocol {
...
extension SendMoneySuccessViewController: UITableViewDataSource {
...
extension SendMoneySuccessViewController: UITableViewDelegate {
