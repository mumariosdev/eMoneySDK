...
SWIFT_CLASS("_TtC22IQKeyboardManagerSwift15IQBarButtonItem") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC22IQKeyboardManagerSwift28IQBarButtonItemConfiguration") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC22IQKeyboardManagerSwift12IQInvocation") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
@interface IQKeyboardManager (SWIFT_EXTENSION(IQKeyboardManagerSwift)) <UIGestureRecognizerDelegate>
...
SWIFT_CLASS("_TtC22IQKeyboardManagerSwift26IQKeyboardReturnKeyHandler") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(IQKeyboardManagerSwift)) <UITextFieldDelegate>
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(IQKeyboardManagerSwift)) <UITextViewDelegate>
...
SWIFT_CLASS("_TtC22IQKeyboardManagerSwift18IQPreviousNextView") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC22IQKeyboardManagerSwift10IQTextView") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC22IQKeyboardManagerSwift20IQTitleBarButtonItem") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC22IQKeyboardManagerSwift9IQToolbar") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
