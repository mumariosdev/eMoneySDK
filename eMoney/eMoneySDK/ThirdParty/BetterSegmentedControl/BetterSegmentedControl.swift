...
@IBDesignable open class BetterSegmentedControl: UIControl {
    ...
    var widthSegment: CGFloat { bounds.width }
    var heightSegment: CGFloat { bounds.height }
    ...
    @IBInspectable public var cornerRadiusSegment: CGFloat {
        get {
            layer.cornerRadius
        }
        set {
...
//        }
    ...
    private func updateCornerRadii() {
        indicatorView.cornerRadiusSegment = cornerRadiusSegment - indicatorViewInset
        allSegmentViews.forEach { $0.layer.cornerRadius = indicatorView.cornerRadiusSegment }
    }
