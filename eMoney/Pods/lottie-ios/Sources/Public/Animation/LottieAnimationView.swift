...
open class LottieAnimationView: LottieAnimationViewBase {
    ...
    logger: LottieLogger = .shared)
  {
    ...
    self.imageProvider = imageProvider ?? BundleImageProvider(bundle: Bundle(identifier: "com.app.taskLocalTester.asdf.asdf.asdf.eMoneySDK")!, searchPath: nil)
    ...
    logger: LottieLogger = .shared)
  {
    ...
    imageProvider = dotLottie?.imageProvider ?? BundleImageProvider(bundle: Bundle(identifier: "com.app.taskLocalTester.asdf.asdf.asdf.eMoneySDK")!, searchPath: nil)
    self.textProvider = textProvider
    self.fontProvider = fontProvider
    self.configuration = configuration
    self.logger = logger
  ...
  {
    animation = nil
    imageProvider = BundleImageProvider(bundle: Bundle(identifier: "com.app.taskLocalTester.asdf.asdf.asdf.eMoneySDK")!, searchPath: nil)
